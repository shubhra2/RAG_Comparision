...
Welcome to `RAG_Comparision` contributor's guide.
...
If you experience bugs or general issues with `RAG_Comparision`, please have a look
...
You can help improve `RAG_Comparision` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`RAG_Comparision` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `RAG_Comparision`'s files. While this mechanism can
...
```
conda create -n RAG_Comparision python=3 six virtualenv pytest pytest-cov
conda activate RAG_Comparision
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/RAG_Comparision.git
   cd RAG_Comparision
   ```
...
5. Install [pre-commit]:
   ...
   `RAG_Comparision` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/RAG_Comparision
[issue tracker]: https://github.com/<USERNAME>/RAG_Comparision/issues
